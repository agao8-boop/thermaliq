    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
          ...
          <span style={{ fontSize: 9, color: 'var(--lg-ink-35)', fontFamily: 'var(--font-mono)' }}>
            ETA {item.eta}
          </span>
        </div>
        ...
        <div style={{ fontSize: 12, color: 'var(--lg-ink-70)', lineHeight: 1.6, fontFamily: 'var(--font-sans)' }}>
          {item.rationale}
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8 }}>
        {[
          ...
          <div
            ...
            style={{ padding: '10px 12px', borderRadius: 'var(--r-control)', textAlign: 'center' }}
          >
