    ...
    >
      ...
      <ResponsiveContainer width="100%" height={180}>
        <BarChart data={data} barSize={14} margin={{ top: 0, right: 0, left: -20, bottom: 0 }}>
          ...
          />
          <Legend
            wrapperStyle={{ fontSize: 10, color: 'rgba(220,238,226,0.45)', paddingTop: 8 }}
          />
          <Bar dataKey="Comfort Events" fill="#f0b840" radius={[2, 2, 0, 0]} />
          <Bar dataKey="AI Intercepts" fill="#2eff96" radius={[2, 2, 0, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  )
